    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 antialiased">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/70 border-b border-neutral-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="https://wa.me/33666040473" target="_blank" rel="noreferrer" className="hidden sm:inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 px-5 py-3 text-white font-medium shadow transition-all">
      ...
      <section id="services" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 bg-gradient-to-b from-neutral-950 via-neutral-900/50 to-neutral-950 rounded-3xl shadow-xl">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="rounded-2xl border border-neutral-800 bg-neutral-900/70 p-6 shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(137,0,191,0.3)]">
